          ...
          <div className="col-lg-12">
            <Slider className="breed-services-active slick" {...settings}>
              <div className="breed-services-item">
                <div className="thumb">
                  <img
                    src="img/animal-adopt/monkey.jpg"
                    className="img-fluid"
                    width={380}
                    alt=""
                  />
              ...
              <div className="breed-services-item">
                <div className="thumb">
                  <img
                    src="img/animal-adopt/parrot.jpg"
                    alt=""
                    className="img-fluid"
                    width={380}
                  />
              ...
              <div className="breed-services-item">
                <div className="thumb">
                  <img
                    src="img/animal-adopt/panda.jpg"
                    alt=""
                    className="img-fluid"
                    width={380}
                  />
              ...
              <div className="breed-services-item">
                <div className="thumb">
                  <img
                    src="img/animal-adopt/tiger.jpg"
                    alt=""
                    className="img-fluid"
                    width={380}
                  />
